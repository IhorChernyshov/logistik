...
export class TestimonialsComponent {
  ...
  // Photo alt text
  photoAlt = signal<string>('Infinity Logistik & Verpackung Team');
  ...
  testimonials = signal<TestimonialData[]>([
    {
      ...
      avatarUrl: 'https://ui-avatars.com/api/?name=Oleg+H&size=100&background=0E293F&color=fff',
    },
    {
      text: 'Ich arbeite seit einem halben Jahr im Unternehmen. Der Lohn wird immer pünktlich gezahlt, die Arbeitsbedingungen sind gut und das Team ist freundlich. Die Karriereentwicklung unterstützt uns und hilft bei neuen Aufgaben. Ich fühle mich hier sicher und habe Vertrauen in meine Arbeit.',
      name: 'Hanna',
      position: 'Lagerarbeiterin',
      avatarUrl: 'https://ui-avatars.com/api/?name=Hanna+M&size=100&background=0E293F&color=fff',
    },
    {
